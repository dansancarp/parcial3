	...
	<header id="header">
		...
		<nav>
			<ul id="main-nav" class="clearfix">
				<li><a onclick="MostrarFormRegistro()" class="btn">Registro</a></li>
				<li><a onclick="MostrarFormLogin()" class="btn">Login</a> </li>
				<li><a onclick="MostrarListado()" class="btn">Listado</a> </li>
				<?php
				session_start();
				if(isset($_SESSION['id']))
				{
				?>
				<li><a onclick="MostrarFormEditar()" class="btn">Mi perfil</a> </li>
				<?php
				}
				?>
			</ul>
